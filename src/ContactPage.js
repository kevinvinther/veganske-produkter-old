...
const ContactPage = () => {
  ...
  //   window.location.href = `mailto:mail@veganskeprodukter.dk?subject=${encodeURIComponent(
  //     values.subject
  //   )}&body=${encodeURIComponent(values.name)} (${encodeURIComponent(
  //     values.email
  //   )})%0D%0A%0D%0A${encodeURIComponent(values.message)}`;
  // };
  ...
  return (
    <Row gutter={16}>
      ...
      <Col span={12}>
        ...
        <Paragraph>
          Kontakt os ved{" "}
          <a href="mailto:mail@veganskeprodukter.dk">at klikke her</a>, eller
          sende en mail til <i>mail@veganskeprodukter.dk</i>
        </Paragraph>
        ...
        <Paragraph>
          ...
          <br />
          3. Hvis det er muligt, medsend et billede af produktet som vedhæftet
          fil.
          <br />
          4. Skriv en tekst, der beviser at produktet er vegansk (e.g. "Der er
          ingen animalske ingredienser" "Jeg har snakket med producenten, og de
          siger at E### er vegansk", "Det står på pakken", etc.").
          <br />
          5. Hvis du har et billede som yderligere bevis, kan du vedhæfte det i
          din e-mail. (f.eks. et billede af ingredienslisten, samtale med
          producenten, etc.)
        </Paragraph>
        Kontakt os ved{" "}
        <a href="mailto:mail@veganskeprodukter.dk">at klikke her</a>, eller
